(defproject socialweb "0.1.0-SNAPSHOT"
  ...
  :uberjar-name "socialweb.jar"

  ;; Use `lein run` if you just want to start a HTTP server, without figwheel
  :main socialweb.server
  :aot [socialweb.server]
  ...
  :cljsbuild {:builds
              [{:id "app"
                ...
                ;; :figwheel {:on-jsload "socialweb.core/on-figwheel-reload"}

                :compiler {:main socialweb.login
                           :asset-path "js/compiled/out"
                           :output-to "resources/public/js/compiled/socialweb.js"
               ...
               {:id "max"
                ...
                :compiler {:main socialweb.login
                           :asset-path "js/compiled/out"
                           :output-to "resources/public/js/compiled1/socialweb.js"
               ...
               {:id "min"
                ...
                :compiler {:main socialweb.login
                           :asset-path "js/compiled/out"
                           :output-to "resources/public/js/compiled2/socialweb.js"
