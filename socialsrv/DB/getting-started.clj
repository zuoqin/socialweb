...
;; store database uri
(def uri "datomic:dev://localhost:4334/socialsrv_dev")
...
(def schema-tx (read-string (slurp "E:/DEV/clojure/toptal/socialsrv/DB/socialsrv-schema.edn")))
...
(def data-tx (read-string (slurp "E:/DEV/clojure/toptal/socialsrv/DB/output.clj")))
